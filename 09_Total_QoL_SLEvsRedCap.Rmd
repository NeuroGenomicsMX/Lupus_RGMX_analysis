...
addmargins(table(integrated.database$Group, 
                 integrated.database$Female))
```
...
## Ahora obtengo una muestra aleatoria de pacientes con las características de edad de la muestra de controles.  
    ...
    resultados.perm.test.calidad.vida<-permTS(muestra.controles$`Total quality of life`,
                                      muestra.pacientes$`Total quality of life`,
                                      alternative = "greater")
    ...
    resultados.remuestreo.total<- rbind(resultados.remuestreo.total, resultados.remuestreo.i)
     
}
# Exportamos resultados
write.csv(resultados.remuestreo.total, "Resultados_permutation_test_by_resampling/resultados.remuestreo.PermTest.totalQoL.csv")
```
