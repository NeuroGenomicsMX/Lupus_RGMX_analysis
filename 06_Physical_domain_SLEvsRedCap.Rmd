...
We will compare them to volunters from TwinsMX, regarding environmental quality of life domain.
...
resultados.remuestreo.physical <- 
...
## Ahora obtengo una muestra aleatoria de pacientes con las características de edad de la muestra de controles.  
    ...
    # Ahora comparo la variable de ineterés de ambas muestras
    resultados.perm.test.calidad.vida<-permTS(muestra.controles$`Physical health QoL-domain`,
                                      muestra.pacientes$`Physical health QoL-domain`,
                                      alternative = "greater")
    ...
    resultados.remuestreo.physical<- rbind(resultados.remuestreo.physical, resultados.remuestreo.i)
     
}
# Exportamos resultados
write.csv(resultados.remuestreo.physical, "Resultados_permutation_test_by_resampling/resultados.remuestreo.PermTest.physical_RedCap.csv")
```
