...
## Ahora obtengo una muestra aleatoria de pacientes con las características de edad de la muestra de controles.  
    ...
    resultados.perm.test.calidad.vida<-permTS(muestra.controles$`Social relations QoL-domain`,
                                      muestra.pacientes$`Social relations QoL-domain`,
                                      alternative = "greater")
    ...
    resultados.remuestreo.social<- rbind(resultados.remuestreo.social, resultados.remuestreo.i)
     
}
# Exportamos resultados
write.csv(resultados.remuestreo.social, "Resultados_permutation_test_by_resampling/resultados.remuestreo.PermTest.social_Twins.csv")
```
