...
### Total QoL-domain permutation Test SLE vs Twins
...
write.csv(resultados.remuestreo.total, "Resultados_permutation_test_by_resampling/resultados.remuestreo.PermTest.totalQoL_Twins.csv")
```
