...
### Environmental QoL-domain permutation Test SLE vs Twins

```{r Perm test by resampling}
# Creating database to save re-sampling results
resultados.remuestreo.environmental <- 
...
## Ahora obtengo una muestra aleatoria de pacientes con las características de edad de la muestra de controles.  
    ...
    resultados.perm.test.calidad.vida<-permTS(muestra.controles$`Environmental QoL-domain`,
                                      muestra.pacientes$`Environmental QoL-domain`,
                                      alternative = "greater")
    ...
    resultados.remuestreo.environmental<- rbind(resultados.remuestreo.environmental, resultados.remuestreo.i)
     
}
# Exportamos resultados
write.csv(resultados.remuestreo.environmental, "Resultados_permutation_test_by_resampling/resultados.remuestreo.PermTest.environmental_Twins.csv")
```
